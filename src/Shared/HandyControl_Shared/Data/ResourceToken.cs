namespace HandyControl.Data
{
    public class ResourceToken
    {
        ...
        #region Converter
            public const string Positive2Nagative = nameof(Positive2Nagative);
            public const string SpeedConverter = nameof(SpeedConverter);
            public const string ValueToBrushConverter = nameof(ValueToBrushConverter);
        ...
        #region Font
            public const string LargeFontSize = nameof(LargeFontSize);
            public const string HeadFontSize = nameof(HeadFontSize);
            public const string SubHeadFontSize = nameof(SubHeadFontSize);
            public const string TextFontSize = nameof(TextFontSize);
        #endregion

        #region Path
        public const string PathBaseStyle = nameof(PathBaseStyle);
        public const string SearchPathStyle = nameof(SearchPathStyle);
        public const string FullScreenReturnPathStyle = nameof(FullScreenReturnPathStyle);
        public const string FullScreenPathStyle = nameof(FullScreenPathStyle);
        public const string WindowsPathStyle = nameof(WindowsPathStyle);
        public const string SavePathStyle = nameof(SavePathStyle);
        public const string DownloadPathStyle = nameof(DownloadPathStyle);
        public const string EnlargePathStyle = nameof(EnlargePathStyle);
        public const string ReducePathStyle = nameof(ReducePathStyle);
        public const string RotatePathStyle = nameof(RotatePathStyle);
        public const string CalendarPathStyle = nameof(CalendarPathStyle);
        public const string DeletePathStyle = nameof(DeletePathStyle);
        public const string ClosePathStyle = nameof(ClosePathStyle);
        public const string DownPathStyle = nameof(DownPathStyle);
        public const string ClockPathStyle = nameof(ClockPathStyle);
        public const string LeftPathStyle = nameof(LeftPathStyle);
        public const string RightPathStyle = nameof(RightPathStyle);
        public const string UpDownPathStyle = nameof(UpDownPathStyle);
        #endregion

        #region Size
        public const string DefaultControlHeight = nameof(DefaultControlHeight);
        public const string DefaultControlPadding = nameof(DefaultControlPadding);
        public const string DefaultInputPadding = nameof(DefaultInputPadding);
        public const string DefaultCornerRadius = nameof(DefaultCornerRadius);
        #endregion

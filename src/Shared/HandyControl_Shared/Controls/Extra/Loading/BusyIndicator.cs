...
namespace HandyControl.Controls
{
    ...
    /// </summary>
    [TemplateVisualState(Name = StateIdle, GroupName = GroupBusyStatus)]
    [TemplateVisualState(Name = StateBusy, GroupName = GroupBusyStatus)]
    ...
    public class BusyIndicator : ContentControl
    {
        ...
        {
            VisualStateManager.GoToState(this, IsBusy ? StateBusy : StateIdle, useTransitions);
            VisualStateManager.GoToState(this, IsContentVisible ? StateVisible : StateHidden, useTransitions);
        }
